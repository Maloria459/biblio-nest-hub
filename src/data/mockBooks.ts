...
export const mockBooks: Book[] = [
  { id: "1", title: "L'Étranger", author: "Albert Camus", coverUrl: "https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=180&h=244&fit=crop", rating: 5, coupDeCoeur: true, status: "Lecture terminée", genre: "Contemporain", format: "Poche", publisher: "Gallimard" },
  { id: "2", title: "Le Petit Prince", author: "Antoine de Saint-Exupéry", coverUrl: "https://images.unsplash.com/photo-1512820790803-83ca734da794?w=180&h=244&fit=crop", rating: 4, coupDeCoeur: false, status: "Lecture terminée", genre: "Fantasy", format: "Broché", publisher: "Gallimard" },
  { id: "3", title: "Les Misérables", author: "Victor Hugo", rating: 5, coupDeCoeur: true, status: "Lecture en cours", genre: "Historique", format: "Relié", publisher: "Hachette" },
  { id: "4", title: "Germinal", author: "Émile Zola", coverUrl: "https://images.unsplash.com/photo-1543002588-bfa74002ed7e?w=180&h=244&fit=crop", status: "Acheté", genre: "Historique", format: "Poche", publisher: "Flammarion" },
